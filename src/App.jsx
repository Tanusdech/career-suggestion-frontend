...
//   // เก็บคำถามที่สุ่มแล้วใน state
//   const [shuffledQuestions, setShuffledQuestions] = useState(() => shuffle(questionsData));
...
//     // ไม่ต้องแปลงซ้ำ เพราะ answers เป็นตัวเลขแล้ว
//     setTimeout(() => {
//       const topCareers = analyzeAnswers(answers);
//       setResults(topCareers);
//       setIsSubmitting(false);
...
//     setAnswers({});
//     setResults(null);
//     setShuffledQuestions(shuffle(questionsData)); // สุ่มคำถามใหม่
//   };
...
//         onAnswerChange={handleAnswerChange}
//         onSubmit={handleSubmit}
//         questions={shuffledQuestions} // ใช้คำถามที่สุ่มแล้ว
//         isSubmitting={isSubmitting}
//       />
